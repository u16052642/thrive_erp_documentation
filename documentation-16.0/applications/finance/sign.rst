...
**Thrive Bureau ERP Sign** allows you to send, sign and approve documents online, using electronic signatures.
...
countries. The legal validity of electronic signatures generated by Thrive Bureau ERP depends on your country's
...
Thrive Bureau ERP generates the first type, **simple electronic signatures**; these signatures are legally valid
...
#. Document traceability and inalterability (any alteration made to a signed document is detected by
   Thrive Bureau ERP with the use of cryptographic proofs)
...
#. **The signature must be clearly attributed**. In Thrive Bureau ERP, metadata, such as the signer's IP address,
...
.. image:: sign/tip-placeholder.png
   :align: center
   :alt: Tip and placeholder example in Thrive Bureau ERP Sign
