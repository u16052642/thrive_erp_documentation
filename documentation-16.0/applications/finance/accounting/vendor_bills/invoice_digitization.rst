...
Thrive Bureau ERP uses :abbr:`OCR (optical character recognition)` and artificial intelligence technologies to
...
.. seealso::
   - `Test Thrive Bureau ERP's invoice digitization <https://www.Thrive Bureau ERP.com/app/invoice-automation>`_
   - `Thrive Bureau ERP Tutorials: Invoice Digitization with OCR
     <https://www.Thrive Bureau ERP.com/slides/slide/digitize-bills-with-ocr-1712>`_
...
.. note::
   ...
   invoices to the :guilabel:`Finance` workspace (e.g., `inbox-financial@example.Thrive Bureau ERP.com`).
...
and click on :guilabel:`Buy credits`, or go to :menuselection:`Settings --> Thrive Bureau ERP IAP` and click on
:guilabel:`View My Services`.

.. important::
   If you are on Thrive Bureau ERP Online and have the Enterprise version, you benefit from free trial credits to
   test the feature.

.. seealso::
   - `Our Privacy Policy <https://iap.Thrive Bureau ERP.com/privacy#header_6>`_
