...
The Thrive Bureau ERP *Sales*, *eCommerce*, and *Point of Sale* applications allow users to create discount and
...
If no discount or loyalty programs have been created yet, Thrive Bureau ERP provides a choice of templates to
...
- :guilabel:`Discount Code`: Enter a custom code to be used for the :guilabel:`Discount Code`
  program, or use the default one generated by Thrive Bureau ERP. This field is only available when the
