...
.. image:: apps_modules/apps-search-filter.png
   :align: center
   :alt: Add "Extra" filter in Thrive Bureau ERP Apps

.. warning::
   Thrive Bureau ERP is *not a smartphone*, and its apps shouldn't be installed or uninstalled carelessly. Apply
   ...
   - | **Thrive Bureau ERP apps have dependencies.**
...
On some occasions, new improvements or app features are added to :doc:`supported versions of Thrive Bureau ERP
...
may uninstall multiple apps and modules. Thrive Bureau ERP warns you which dependent apps and modules are
affected by it.
