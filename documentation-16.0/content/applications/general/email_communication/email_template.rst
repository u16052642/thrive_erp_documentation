...
communication between your customer and your Thrive Bureau ERP database. For more information about the way
...
When using Thrive Bureau ERP, multiple events trigger the sending of automated emails. These emails are known
as transactional emails and sometimes contain links pointing to your Thrive Bureau ERP database.
...
This is not always the case as some Thrive Bureau ERP applications have a link established in the database with
...
On the other hand, sales orders made by a customer on one of your Thrive Bureau ERP e-commerce websites have a
