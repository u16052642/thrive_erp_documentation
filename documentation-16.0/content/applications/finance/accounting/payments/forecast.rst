...
In Thrive Bureau ERP, you can manage payments by setting automatic **Payments Terms** and **follow-ups**.

Configuration: payment terms
============================

In order to track vendor conditions, we use **Payment Terms** in Thrive Bureau ERP. They allow keeping track of
...
and select a specific **Payment Term**. This way, every time you purchase from this vendor, Thrive Bureau ERP
