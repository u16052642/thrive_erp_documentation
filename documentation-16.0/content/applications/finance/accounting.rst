...
**Thrive Bureau ERP Invoicing** is a standalone invoicing app to create invoices, send them to your customers,
and manage payments.

**Thrive Bureau ERP Accounting** is a full featured accounting app. Accountant productivity is at the core of its
...
Thrive Bureau ERP automatically creates all the underlying journal entries for all accounting transactions (e.g.,
customer invoices, vendor bills, point-of-sales orders, expenses, inventory valuations, etc.).

Thrive Bureau ERP uses the double-entry bookkeeping system, whereby every entry needs a corresponding and
...
Both accrual and cash basis accounting are supported in Thrive Bureau ERP. This allows reporting income and
...
exchange rate to ease international transactions is available in Thrive Bureau ERP. Every transaction is recorded
in the company's default currency; for transactions occurring in another currency, Thrive Bureau ERP stores both
the value in the company's currency and the transactions' currency value. Thrive Bureau ERP generates currency
...
Thrive Bureau ERP Accounting supports more than 70 countries. It provides the central standards and mechanisms
...
.. tip::
   :doc:`Create and customize reports <accounting/reporting/customize>` with Thrive Bureau ERP's report engine.

Tax report
----------

Thrive Bureau ERP computes all accounting transactions for the specific tax period and uses these totals to
calculate the tax obligation.

.. important::
   Once the tax report has been generated for a period, Thrive Bureau ERP locks it and prevents the creation of
...
Both periodic (manual) and perpetual (automated) inventory valuations are supported in Thrive Bureau ERP. The
...
Retained earnings are the portion of income retained by a business. Thrive Bureau ERP calculates current year
