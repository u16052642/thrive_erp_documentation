...
Thrive Bureau ERP automatically timesheets on project/tasks upon time off requests. This allows for better
...
.. image:: time_off/record_time_off.png
   :align: center
   :alt: View of Timesheets setting enabling the feature record time off in Thrive Bureau ERP Timesheets
...
.. image:: time_off/time_off_request.png
   :align: center
   :alt: View of the time off request form in Thrive Bureau ERP Time Off
...
.. image:: time_off/timesheets.png
   :align: center
   :alt: Video of timesheets emphasizing the requested time off from the employee in Thrive Bureau ERP Timesheets
...
.. image:: time_off/timesheet_description.png
   :align: center
   :alt: View of the details of a project/task in Thrive Bureau ERP Timeheets
