...
Thrive Bureau ERP *Helpdesk* includes several reports that provide the opportunity to track trends for customer
...
Details about the reports available in Thrive Bureau ERP *Helpdesk* can be found below. To view the different
...
On any Thrive Bureau ERP report, the view and filter options vary, depending on what data is being analyzed,
...
.. image:: reports/pivot-view.png
   :align: center
   :alt: View of the SLA status analysis report in Thrive Bureau ERP Helpdesk.
...
.. image:: reports/save-filters.png
   :align: center
   :alt: View of the save favorites option in Thrive Bureau ERP Helpdesk.

.. seealso::
   - :doc:`Start receiving tickets </applications/services/helpdesk/overview/receiving_tickets>`
   - :doc:`Thrive Bureau ERP reporting </applications/general/reporting>`
